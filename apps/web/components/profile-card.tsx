...
import { Clock, Mail, ArrowUpRight, Globe, Briefcase } from "lucide-react";
...
export default function Component({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "relative w-full max-w-4xl mx-auto flex justify-center items-center h-screen",
                className
            )}
        >
                ...
                <CardContent className="relative p-8 sm:p-10">
                    ...
                    <div className="mb-8 flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                            ...
                            <p className="mb-3 text-lg font-medium text-purple-400">
                                {role}
                            </p>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        >
                            <Button className="relative h-14 w-full overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 to-cyan-600 font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:from-purple-700 hover:to-cyan-700">
